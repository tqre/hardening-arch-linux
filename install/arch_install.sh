...
# Tested on UpCloud server
# If the installation ISO is old, run pacman -S archlinux-keyring first
...
# DNS settings:
# UpCloud DNS servers here. How about DNSSEC?
DNS_SERVER="94.237.127.9"
DNS_SERVER2="94.237.40.9"
...
echo -e "nameserver $DNS_SERVER\nnameserver $DNS_SERVER2" > /mnt/etc/resolv.conf
